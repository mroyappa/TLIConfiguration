namespace TLIConfiguration
{
	partial class AMUEdit
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AMUEdit));
			...
			this.toolTip.SetToolTip(this.customXceedGridControl, "AMU Configuration - A list of all AMUs being used for gauging in a Configurable T" +
					"LI installation.");
			...
			this.Text = "AMU Configuration";
			this.Load += new System.EventHandler(this.AMUEdit_Load);
