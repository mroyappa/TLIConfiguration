namespace TLIConfiguration
{
	partial class MTDEEdit
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MTDEEdit));
			...
			this.customXceedGridControl.TabIndex = 6;
			this.toolTip.SetToolTip(this.customXceedGridControl, "The list of MTDEs configured for a vessel.");
			...
			this.Text = "MTDE Configuration";
			this.Load += new System.EventHandler(this.MTDEEdit_Load);
