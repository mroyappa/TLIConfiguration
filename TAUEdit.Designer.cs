namespace TLIConfiguration
{
	partial class TAUEdit
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TAUEdit));
			...
			this.toolTip.SetToolTip(this.customXceedGridControl, "TAU Configuration - A list of all TAUs being used for gauging in a Configurable T" +
					"LI installation.");
			...
			this.Text = "TAU Configuration";
			this.Load += new System.EventHandler(this.TAUEdit_Load);
