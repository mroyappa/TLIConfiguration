...
{
	partial class AlarmAnnunciationEdit
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AlarmAnnunciationEdit));
			...
			this.cmdOk.Location = new System.Drawing.Point(462, 477);
			...
			this.cmdCancel.Location = new System.Drawing.Point(543, 477);
			...
			this.customXceedGridControl.Size = new System.Drawing.Size(607, 459);
			this.customXceedGridControl.TabIndex = 3;
			this.toolTip.SetToolTip(this.customXceedGridControl, "Alarm Annunciations - ·\tA list of available AMU digital outputs which can be used" +
					" to enunciate an active alarm (i.e., sound a cabinet buzzer, turn on a strobe l" +
					"ight, etc.).\r\n\r\n");
			...
			this.Name = "AlarmAnnunciationEdit";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Alarm Annunciations";
			this.Load += new System.EventHandler(this.AlarmAnnunciationEdit_Load);
