...
{
	partial class RedundantSequenceNumberExceptions
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RedundantSequenceNumberExceptions));
			...
			// 
			// RedundantSequenceNumberExceptions
			// 
			...
			this.Name = "RedundantSequenceNumberExceptions";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Sequence Exceptions";
			this.Load += new System.EventHandler(this.RedundantSequenceNumberExceptions_Load);
