...
{
	partial class ModularBubblerEdit
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModularBubblerEdit));
			...
			this.toolTip.SetToolTip(this.customXceedGridControl, "Modular Bubbler Configuration - A list of all Modular Bubblers being used for gau" +
					"ging in a Configurable TLI installation.");
			...
			this.Name = "ModularBubblerEdit";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Modular Bubbler Configuration";
			this.Load += new System.EventHandler(this.ModularBubblerEdit_Load);
