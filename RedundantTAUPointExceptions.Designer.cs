...
{
	partial class RedundantTAUPointExceptions
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RedundantTAUPointExceptions));
			...
			this.Name = "RedundantTAUPointExceptions";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "TAU Channel Exceptions";
			this.Load += new System.EventHandler(this.RedundantTAUPointExceptions_Load);
