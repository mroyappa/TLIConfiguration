...
{
	partial class AlarmPriorityEdit
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AlarmPriorityEdit));
			...
			this.customXceedGridControl.TabIndex = 4;
			this.toolTip.SetToolTip(this.customXceedGridControl, "Alarm Priorities - An ordinal list used to create a prioritized structure when de" +
					"fining alarms.  This is used by the TLI Runtime when determining the most signif" +
					"icant active alarm.");
			...
			this.Name = "AlarmPriorityEdit";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Alarm Priorities";
			this.Load += new System.EventHandler(this.AlarmPriorityEdit_Load);
